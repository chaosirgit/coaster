...
$app->post('api/relationship/sendrequest','RelationshipController@send_request');
$app->post('api/relationship/cancelrequest','RelationshipController@cancel_request');
$app->post('api/relationship/denyrequest','RelationshipController@deny_request');
$app->post('api/relationship/acceptrequest','RelationshipController@accept_request');
$app->get('api/relationship','RelationshipController@get_relation');
$app->delete('api/relationship','RelationshipController@del_relation');
